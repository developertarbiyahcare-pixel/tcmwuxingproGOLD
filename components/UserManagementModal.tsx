           ...
           {activeTab === 'users' ? (
             ...
             <div className="space-y-6">
                <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100 space-y-4">
                  ...
                  <button 
                    onClick={onLogout}
                    className="hidden w-full py-3 bg-purple-100 text-purple-600 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-purple-200 transition-all flex items-center justify-center gap-2"
                  >
